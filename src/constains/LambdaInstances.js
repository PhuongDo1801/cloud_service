export const LambdaInstances = [
    { key: 'FunctionName', class: 'text-align-left', style: 'min-width: 150px;', text: 'FunctionName', title:"" },
    { key: 'Runtime-value', class: 'text-align-left', style: 'min-width: 200px;', text: 'Runtime-value', title:"" },
